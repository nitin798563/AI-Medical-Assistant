...
import type { doctorAgent } from '../../_component/DoctorAgentCard';
...
const VapiAgentConfig = {
  ...
  const endCall = () => {
    ...
    //optional remove listeners (good for every managemnet)
  ...
  return (
    <div className='p-5 border rounded-3xl bg-secondary'>
      ...
      {sessionDetail && <div className='flex items-center flex-col mt-10'>
        ...
        {!callStarted ? <Button className='mt-20 cursor-pointer' onClick={StartCall}><PhoneCall />Start Call</Button> :
